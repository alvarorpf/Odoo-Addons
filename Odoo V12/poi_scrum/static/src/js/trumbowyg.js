odoo.define('poi_scrum.trumbowyg', function (require) {
    'use strict';
    ...
    require('poi_scrum.trumbowyg.upload-file');

    // Fix trumbowyg svg icons path
    $.trumbowyg.svgPath = "/poi_scrum/static/lib/trumbowyg/dist/ui/icons.svg";
                    ...
                    trumbowyg.pasteHandlers.push(function (pasteEvent) {
                        ...
                        $.each(clipboardData.files, function (index, file) {
                            if (file.type.match(/^image\//)) {
                                ajax.post('/poi_scrum/file_upload', {
                                    'upload': file,
                                    'is_image': true,
    ...
    var trumbowyg_options = {
        ...
        plugins: {
            uploadFile: {
                serverPath: '/poi_scrum/file_upload/',
