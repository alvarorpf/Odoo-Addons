odoo.define('poi_scrum.project_list_view', function (require) {
"use strict";
...
var ProjectList = Widget.extend({
    template: 'poi_scrum.project_list',
    /* Lifecycle */
    init: function (parent, projects) {
        this._super.apply(this, arguments);
        this.projects = projects;
    },
    xmlDependencies: ['/poi_scrum/static/src/xml/project.xml'],
    /**
     ...
     */
    _rerender: function () {
        this._replaceElement(qweb.render('poi_scrum.project_list', {widget: this}));
    },
