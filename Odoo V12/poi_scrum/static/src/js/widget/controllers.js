odoo.define('poi_scrum.controllers', function (require) {
'use strict';
...
var TicketApp = Widget.extend({
    ...
    //     'warning': function (ev) {this.notification.notify({title:ev.data.msg, message: 'aun no da', type: 'warning'});},
    //     'notify': function (ev) {this.notification.notify({title:ev.data.msg, message: 'aun no da'});},
    // },
