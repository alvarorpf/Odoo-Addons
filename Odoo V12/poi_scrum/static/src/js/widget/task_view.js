odoo.define('poi_scrum.task_view', function (require) {
    "use strict";
    ...
    var TaskList = Widget.extend({
        template: 'poi_scrum.task_view',
        /* Lifecycle */
        init: function (parent, task) {
            this._super.apply(this, arguments);
            this.task = task;
        },
        xmlDependencies: ['/poi_scrum/static/src/xml/task_view.xml'],
        /**
         ...
         */
        _rerender: function () {
            this._replaceElement(qweb.render('poi_scrum.task_view', {widget: this}));
        },
    });
